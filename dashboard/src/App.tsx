...
const BulkMessage = lazy(() => import('./pages/BulkMessage').then(m => ({ default: m.BulkMessage })));
const ScheduleMessage = lazy(() => import('./pages/ScheduleMessage').then(m => ({ default: m.ScheduleMessage })));
